...
async def on_sticker(client: Client, message: Message):
    ...
    if message.sticker.set_name in chat_data.banned_stickerpacks:
        # <editor-fold defaultstate="collapsed" desc="logging">
        logger.info(f'[{message.chat.id} ({message.message_id})] Stickerpack {message.sticker.set_name} banned. '
                    f'Deleting...')
        # </editor-fold>
        await message.delete()
        # <editor-fold defaultstate="collapsed" desc="logging">
...
async def on_ban_stickerpack(client: Client, message: Message):
    ...
    # <editor-fold defaultstate="collapsed" desc="logging">
    logger.info(f'[{message.chat.id} ({message.message_id})] Added stickerpack to banned. Reporting...')
    # </editor-fold>
